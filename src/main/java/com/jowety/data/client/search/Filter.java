...
public class Filter  implements Serializable{
	...
	public static enum MatchMode{
	    ...
	    private MatchMode(boolean gouping) {
	 ...
	 * @param match
	 */
	public Filter(Collection<Filter> value, MatchMode match) {
		super();
		this.rightside = Exp.literal(value);
		this.match = match;
	...
	public String toString() {
		ToStringBuilder tsb = new ToStringBuilder(this, ToStringStyle.DEFAULT_STYLE)
				.append("leftSide", this.leftside)
				.append("match", this.match)
				.append("rightSide", this.rightside)
				.append("negate", this.negative);
		return tsb.toString();
	}

	public static  Filter andGroup(Filter... filter){
	 ...
	 * @return
	 */
	LeftSide startWhere(Search search) {
		this.search = search;
		return new LeftSide();
	}
	...
	public class RightSide{
		public Search path(String path) {
			rightside = Exp.path(path);
			return search;
		}
		public Search literal(Object value) {
			rightside = Exp.literal(value);
			return search;
		}
		public Search function(Function func) {
